		...
		MouseListener, ActionListener, PropertyChangeListener
{
	...
	private static JConsole launchedConsole = null;

	public static void launch() { launch("JConsole");
	}
	public static void launch(String title) { launch(title, 500, 500); }
	...
	public static void launch(Container cp) {
		launchedConsole = new JConsole();
		launchedConsole.attach();
		cp.add(launchedConsole);
	}

	public static void exit() {
		if (launchedConsole == null) return;
		launchedConsole.unattach();
		launchedConsole.exited = true;
		launchedConsole = null;
	}
	// end (koz)
	/////////////////////////////////////////////////////
	...
	public void keyPressed( KeyEvent e ) {
		if (exited) { e.consume(); return; } // koz
		type( e );
		gotUp=false;
	}
